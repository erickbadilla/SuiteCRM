                ...
                <div class="" style="display: grid; margin-top: 4px;">
                    <div class="col-sm-12"  style="padding: 0;">
                        ...
                        <div class="col-sm-5" style="padding: 0; padding-left: 2px;">
                            <button type="button" id="add_other_interviewers_{$actionStage->id}" class="btn btn-danger" style="float: right" onclick="IntSelHandler3.showHideAddInterviewers('{$stageId}')">
...
<script type="text/javascript">
    ...
    var IntSelHandler3 = new InterviewerSelectorHandler();
    IntSelHandler3.init(stageId2,jobOfferId);
    ...
    $(document).ready(function (){
        ...
        IntSelHandler3.setSelect2Intance(sheduleSlecet2);
        IntSelHandler3.getInterviewersJobOffer();
        IntSelHandler3.showHideAddInterviewers();
        IntSelHandler3.hideAddInterviewers();

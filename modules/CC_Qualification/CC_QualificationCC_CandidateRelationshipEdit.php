...
echo getClassicModuleTitle($mod_strings['LBL_MODULE_NAME'], array($mod_strings['LBL_MODULE_NAME'],$candidateName['NAME']. " » ".$qualificationName['NAME']), true);
...
$page = $xtpl->fetch('modules/CC_Qualification/CC_QualificationCC_CandidateRelationshipEdit.tpl');
echo $page;

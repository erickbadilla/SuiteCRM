            ...
            <td class="buttons">
                <div class="buttons">
                    <input id="save_btn_48516" class="button primary" type="submit" name="button" class="button"
                           ...
                           onclick="this.form.action.value='SaveCC_QualificationCC_CandidateRelationship';"
                    ...
                    <div class="tab-content">
                        <div class="row detail-view-row">
                            <div class="col-xs-12 col-sm-6 detail-view-row-item">
                                <div class="col-xs-12 col-sm-4 label col-1-label">{$MOD.LBL_CANDIDATE_ACTUAL_QUALIFICATION}</div>
                                <div class="col-xs-12 col-sm-8"><select name='actual_qualification'>{$TYPE_OPTIONS}</select></div>
                                <div class="clearfix">&nbsp;</div>
                            </div>
                            <div class="col-xs-12 col-sm-6 detail-view-row-item">
                                <div class="col-xs-12 col-sm-4 label col-1-label">{$MOD.LBL_CANDIDATE_HAS_DIGITAL_SUPPORT}</div>

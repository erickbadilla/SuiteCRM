 ...
 * @category Views
 */
class CC_Employee_InformationViewList extends ViewList
{
    /**
     * @see SugarView::$type
     */
    ...
    public function displayListViewHandler() {
        ...
        $smarty->display('modules/CC_Employee_Information/tpls/ExcelHandler.tpl');
        $smarty->display('modules/CC_Employee_Information/tpls/ListViewHandler.tpl');
    }

 ...
 * @category Views
 */
class CC_Professional_ExperienceViewList extends ViewList
{
    /**
     * @see SugarView::$type
     */
    ...
    public function display()
    {
        ...
        $html = "<h1>PROFESSIONAL EXPERIENCE</h1>";
        echo $html;
    ...
    public function displayListViewHandler() {
        ...
        $smarty->display('modules/CC_Professional_Experience/tpls/ListViewHandler.tpl');
    }

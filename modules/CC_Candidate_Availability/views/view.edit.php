...
class CC_Candidate_AvailabilityViewEdit extends SugarView
{
    /**
     * @var EditView $ev
     */
    ...
    public function preDisplay()
    {
        ...
        $this->bean->time_1 = empty($this->bean->time_1) ? gmdate("H:i") : $this->bean->time_1;
        $this->bean->time_2 = empty($this->bean->time_2) ? gmdate("H:i") : $this->bean->time_2;
        $this->bean->time_1 = date_create($this->bean->time_1, new DateTimeZone($TimeZoneNameFrom))->setTimezone(new DateTimeZone($TimeZoneNameTo))->format("H:i:s A");
        $this->bean->time_2 = date_create($this->bean->time_2 , new DateTimeZone($TimeZoneNameFrom))->setTimezone(new DateTimeZone($TimeZoneNameTo))->format("H:i:s A");

...
<input type="hidden" name="module" value="CC_Profile" />
...
<td>
	<input id="save_btn_48516" type="submit" name="button" class="button"
		...
		onclick="this.form.action.value='SaveCC_ProfileCC_Job_DescriptionRelationship';"
   ...
   <tr>
      <td>
         <table width="50%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
               <td scope="row"><span class="label">{$MOD.LBL_DEPENDENCY}</span><span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td>

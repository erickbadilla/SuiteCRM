...
<form action="index.php" method="post" name="EditView" onsubmit="return check_form('EditView')">
    ...
    <td>
        <input id="save_btn_48516" type="submit" name="button" class="button"
            ...
            onclick="this.form.action.value='SaveCC_SkillCC_CandidateRelationship';"
            ...
            <div class="panel-content">
                <div class="tab-content">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                        <tr>
                            <td scope="row"><span class="label">{$MOD.LBL_CANDIDATE_SKILL_RATING}</span><span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td>
                            <td ><span>

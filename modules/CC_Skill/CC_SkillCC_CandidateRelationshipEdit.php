...
$focus = new CC_SkillCC_CandidateRelationship();
...
echo getClassicModuleTitle($mod_strings['LBL_MODULE_NAME'], array($mod_strings['LBL_MODULE_NAME'],$skillName['NAME']. " - ".$candidateName['NAME']), true);
...
$page = $xtpl->fetch('modules/CC_Skill/CC_SkillCC_CandidateRelationshipEdit.tpl');
echo $page;

<?php header('Access-Control-Allow-Origin: http://167.172.244.38/upload'); ?>
<?php
/**
 *
 ...
 * @category Views
 */
class CC_CandidateViewList extends ViewList
{
    /**
     * @see SugarView::$type
     */
    ...
    public function displayListViewHandler() {
        ...
        $smarty->display('modules/CC_Candidate/tpls/ListViewHandler.tpl');
    }
}
